...
​    List<Integer> xingxing = new ArrayList<Integer>();

​    fixxingxing(root,xingxing); //方法
...
​    return xingxing;
  ...
  public void fixxingxing(TreeNode root,List<Integer> xing){
...
​    fixxingxing(root.left,xing);  

​    //右

​    fixxingxing(root.right,xing);  
